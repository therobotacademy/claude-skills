...
| Build a domain knowledge graph & downloadable Obsidian vault from a URL + references | [`build-obsidian-knowledge-vault`](skills/content/build-obsidian-knowledge-vault/) |
...
| [`build-obsidian-knowledge-vault`](skills/content/build-obsidian-knowledge-vault/) | Creates a domain-adapted knowledge graph from a primary URL or exported doc, reading first-level references, synthesizing entities and claims with explicit provenance, and delivering an operational downloadable Obsidian vault. Includes genesis & design decisions record in [`CONTEXTO_CREACION.md`](skills/content/build-obsidian-knowledge-vault/CONTEXTO_CREACION.md). |
