...
| [`build-obsidian-knowledge-vault`](skills/content/build-obsidian-knowledge-vault/) | Creates a domain-adapted knowledge graph from a primary URL or exported doc, reading first-level references, synthesizing entities and claims with explicit provenance, and delivering an operational downloadable Obsidian vault.                                                                                                                                                                                                                                                  |
